...
public class AVLTreePrinter {
    ...
    private AVLSearchTree<Integer> tree;  // the tree
     ...
     */
    public AVLTreePrinter(AVLSearchTree<Integer> tree)
    {
        this.tree = tree;
    ...
    {       
        ...
        AVLnode<Integer> thisLevelNodes[] = 
                (AVLnode<Integer>[]) new AVLnode[1];
    ...
    private void printData(int level, int offset, 
                           AVLnode<Integer> levelNodes[])
    {
        printSpaces(offset);
        
        int k = POWERS_OF_2[level];
        for (int i = 0; i < k; i++) {
            AVLnode<Integer> node = levelNodes[i];
     ...
     */
    private AVLnode<Integer>[] nextLevel(int level, 
                                            AVLnode<Integer> levelNodes[])
    {
        AVLnode<Integer> nextLevel[] = 
                (AVLnode<Integer>[]) new AVLnode[POWERS_OF_2[level+1]];
